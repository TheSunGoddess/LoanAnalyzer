...
#calculate the total number of loans from loan_costs
total_number_loans = len(loan_costs)
print("The length of the loans list is" + "{loan_costs_length}")

print(f"The total Number of Loans is {total_number_loans}.")
#calculate the sum of loan_costs
sum_of_loans = sum(loan_costs)
print(f"The total of all loans is {sum_of_loans}")
#calculate the overall average of the loans
average_of_loans = sum_of_loans / total_number_loans
...
print(f"The remaining months are as follows: {remaining_months}.")
